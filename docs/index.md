...
!!! info
    ...
    **Source Code Repository:** [https://github.com/redhat-appstudio-mjf/chatbot-test-sep16-1](https://github.com/redhat-appstudio-mjf/chatbot-test-sep16-1)

    **GitOps Repository:** [https://github.com/redhat-appstudio-mjf/chatbot-test-sep16-1-gitops](https://github.com/redhat-appstudio-mjf/chatbot-test-sep16-1-gitops)

# **Usage**

To access the chatbot-test-sep16-1 application that was deployed using the Software Template, complete the following instructions:
...
If you are interested in seeing the deployed Kubernetes resources, all resources were deployed into your chosen namespace of lucas. You can access this namespace through the web console or via your CLI.
